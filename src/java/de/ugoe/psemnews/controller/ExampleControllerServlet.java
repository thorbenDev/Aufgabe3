 ...
 * Beispiel-Controller
 */
@WebServlet(description = "Beispielcontroller", urlPatterns = { "/ExampleControllerServlet" })
public class ExampleControllerServlet extends HttpServlet {
...
//                auf eingabe von ArticleID prüfen
	...
	private void forwardToErrorView(HttpServletRequest request, HttpServletResponse response, 
		...
		RequestDispatcher rd = request.getRequestDispatcher("example-error.jsp");
        rd.forward(request, response);
	}
